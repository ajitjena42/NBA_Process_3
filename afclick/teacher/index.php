...
{
$ret=mysqli_query($con,"SELECT * FROM teacher WHERE teacher_id='".$_POST['username']."' and t_password='".md5($_POST['password'])."'");
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html">	<h2> Vidyalankar | Teacher Login</h2></a>
				</div>
				<div class="box-login">
