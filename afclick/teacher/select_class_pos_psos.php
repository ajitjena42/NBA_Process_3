...
$_SESSION['subject']=$_POST['submit1'];
	header('Location: total_attain_pos_psos.php');
}
...
<html lang="en">
	<head>
		<title>Teacher |Final Attainment of PO's/PSO's</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Teacher | Final Attainment of PO's/PSO's</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Teacher</span>
									...
									<li class="active">
										<span>Final Attainment of PO's/PSO's</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-12 col-md-12">
											<div class="panel panel-white ">
												<div class="panel-heading">
													<h5 class="panel-title">Select Year and Class to Add Marks</h5>
												</div>
                        ...
                        Click here to view subjects
									...
									<div class="row margin-top-30">
										<div class="col-lg-12 col-md-12">
											<div class="panel panel-white ">
												<div class="panel-heading">
													<h5 class="panel-title">Select class to enter marks</h5>
                                                    <br>
