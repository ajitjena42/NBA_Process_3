...
if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($con,"select t_email from  teacher where teacher_id='$teacherid'");
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html"><h2> Vidyalankar | Teacher Password Recovery</h2></a>
				</div>
						...
						<fieldset>
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									<input type="text" class="form-control" name="teacherid" placeholder="Enter your ID">
