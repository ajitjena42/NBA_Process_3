...
if($row=mysqli_fetch_array($sql)){
    ...
    echo "<script>alert('You have not set co for PT2');</script>";
    echo '<script>setTimeout(function(){ location.href = "comap_pt2.php"; }, 1);</script>';
}
    ...
    $sql=mysqli_query($con,"select * from student p,assignsubject a where a.years='".$years."' AND p.years='".$years."' AND p.class_name='".$class."' AND a.class_name='".$class."' AND a.sub_name='".$subject."' GROUP BY p.st_id");
        ...
        $row1=mysqli_fetch_array($sql);
            ...
            $co6=$co[3];
                ...
                mysqli_query($con,"UPDATE `cos` SET `co1`='-',`co2`='-',`co3`= '$co3',`co4`= '$co4',`co5`= '$co5',`co6`= '$co6' WHERE `years`='$year' AND class_name='".$cname."' AND sub_name='".$s1name."' AND exam='PT2' ");
        ...
        if($abs==1){
            ...
            $Bd="-";
                ...
                mysqli_query($con,"INSERT INTO `pt2` (`pt2_id`, `years`, `class_name`, `sub_name`, `teacher_id`, `st_id`, `st_name`, `1a`, `1b`, `1c`, `1d`, `1e`, `1f`, `2a`, `2b`, `2c`, `2d`, `total`,`absent`) VALUES (NULL, '$year', '$cname', '$sname1', '$tid', '$sid', '$sname', '$Aa', '$Ab', '$Ac', '$Ad', '$Ae', '$Af', '$Ba', '$Bb', '$Bc', '$Bd', '$total','$abs')");
            $i+=1;   
        }
        $j=0;
        $co=$_POST['item_attainmentco'];
        ...
        $row1=mysqli_fetch_array($sql);
            ...
            $co5=$co[2];
            $co6=$co[3];
            mysqli_query($con,"INSERT INTO `cos` (`cos_id`, `years`, `dept_name`, `sem`, `class_name`, `exam`,`sub_name`, `teacher_id`, `co1`, `co2`, `co3`, `co4`, `co5`, `co6`) VALUES (NULL, '$year', '$dname', '$sem', '$cname','$exampage', '$sname', '$tid', '-', '-', '$co3', '$co4', '$co5', '$co6')");
            $j+=1;   
        }
    }
        ...
        ?>
          <thead>
              ...
              <tr>
               ...
               <th colspan="3"style="text-align:center;"><?php echo $years;?></th>
               <th colspan="5"style="text-align:center;">PT2</th>
              </tr>
               <tr>
...
//                echo "<script>alert('".$years."');</script>";
                ...
                <tr>
                    ...
                    $sql=mysqli_query($con,"SELECT * FROM subject s,comap_pt2 c where s.sub_id=c.sub_id AND s.years='".$years."' AND s.dept_name='".$dept."' AND s.sub_name='".$subject."'");
                        ...
                        ?>
                            ...
                            <td><input type="text"name="item_nameoutcome1[]"class="form-control item_name"   style="width:78px"autocomplete="off" readonly/></td>
                        <td colspan="1"></td>
                </tr>
                <tr>
       ...
       <input type="submit" class="btn btn-primary"id="submit" name="submit" value="<?php $sql1=mysqli_query($con,"select * from pt2 where years='".$years."' AND class_name='".$class."' AND sub_name='$subject' GROUP BY st_id");
       ...
       <script src="https://code.jquery.com/jquery-3.4.1.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>
        ...
        <script>
            ...
            function total1(){
                ...
                if(co1n==0){
                $('input[name="item_attainmentco[]"]').get(0).value="-";
                $(".co3").hide();
                }
                if(co4n==0){
            ...
            function total(){
                ...
                {    
                    ...
                    $('input[name="item_nameabs1[]"]').map(function(){
                        $('input[name="item_namehid1[]"]').get(j).value=0;
                        j+=1;
                    })
                    j=0;
                    $('input[name="item_nameabs1[]"]').map(function(){
