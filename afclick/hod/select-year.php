...
if(isset($_POST['submit2']))
{
    ...
    header('Location: last-fullfinal-attainment-year.php');
}
...
<html lang="en">
	<head>
		<title>HOD | Direct Attainment of PO's</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">HOD | Direct Attainment of PO's</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>HOD</span>
									...
									<li class="active">
										<span>Direct Attainment of PO's</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-12 col-md-12">
											<div class="panel panel-white ">
												<div class="panel-heading">
													<h5 class="panel-title">Select academic year to see Direct Attainment of PO's</h5>
												</div>
