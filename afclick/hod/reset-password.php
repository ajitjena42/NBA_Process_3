...
if(isset($_POST['change']))
{
	if($_SESSION['endtime'] > date("d-m-Y h:i:sa"))
    {
        ...
        if(strcmp($rno,$urno)==0)
        {
			...
			$query=mysqli_query($con,"update hod set hod_password='$newpassword' where hod_id='$cno' and hod_email='$email'");
			if ($query == true) 
			{
				$subject = "Vidyalankar | HOD Reset Password"; 
				$txt = "<h1> Vidyalankar | HOD Reset Password </h1><br>";
...
if(isset($_POST['resend']))
{
    ...
    $rno=$_SESSION['otp'];
	$to=$_SESSION['email'];
	$subject = "Vidyalankar | HOD password recovery"; 
		$txt = "<h1> Vidyalankar | HOD password recovery </h1><br>";
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> Vidyalankar | HOD Reset Password</h2></a>
				</div>
