...
if (ISSET($_POST['submit'])) {
        ...
        $row1=mysqli_fetch_array($sql);
            ...
            $co4=$co[3];
                ...
                mysqli_query($con,"UPDATE `cos` SET `co1`='$co1',`co2`='$co2',`co3`= '$co3',`co4`= '$co4',`co5`= '0',`co6`= '0' WHERE `years`='$year' AND class_name='".$cname."' AND sub_name='".$s1name."' AND exam='PT1' ");
        ...
        ?>
          <thead>
              ...
              <tr>
               ...
               <th colspan="5"style="text-align:center;"><?php echo $row['dept_name'];?>(<?php echo $class;?>)</th>
            ...
            if( $row1=mysqli_fetch_array($sql1)){
               ...
               <tfoot>
                ...
                <tr>
                  ...
                  <?php
                $sql1=mysqli_query($con,"select * from cos where years='".$years."' AND class_name='".$class."' AND sub_name='$subject' AND exam='PT1' ");
            if( $row1=mysqli_fetch_array($sql1)){
