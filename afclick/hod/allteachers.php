					...
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
                            ...
                            <div class="row margin-top-30">
										<div class="col-lg-12 col-md-12">
											<div class="panel panel-white ">
												<div class="panel-heading">
													<h5 class="panel-title">Select academic year to see teachers list</h5>
												</div>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">List of <span class="text-bold">Teachers</span></h5> year <?php echo $_SESSION['year']; ?>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"SELECT a.dept_name, a.class_name as class, a.teacher_id as tid ,a.sub_name as sub,b.teacher_name as name, b.teacher_id FROM assignsubject a, teacher b WHERE a.teacher_id = b.teacher_id AND a.years = '".$_SESSION['year']."' AND a.dept_name='".$_SESSION['dept_name']."'");
$cnt=1;
...
?>
											...
											<tr>
												...
												<td class="hidden-xs"><?php echo $row['tid'];?></td>
